<?php
    ini_set('display_error', 1); // 1 means true
	...
	<div class="container">
  	...
  	?>
		...
		<div class="form-group">
            ...
            <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" class="form-control" name="email" placeholder="Enter your email" aria-describeby="emailHelp"></input>
